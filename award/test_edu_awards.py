...
class EducationAwardTest(TestCase):
    ...
    def test_award_value_not_zero(self):
        with self.assertRaisesRegexp(ValidationError, "Award value is cannot be zero."):
            ea = EducationAward()
    ...
    def test_award_value_5_digits(self):
        with self.assertRaisesRegexp(ValidationError, "Award value must be 5 digits or less in length."):
            ea = EducationAward()
