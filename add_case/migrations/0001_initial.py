    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caseType', models.CharField(choices=[(b'ARBITRATION', b'ARBITRATION'), (b'DISABILITY CLAIMS', b'DISABILITY CLAIMS'), (b'COMPLAINT', b'COMPLAINT'), (b'GRIEVANCES - POLICY', b'GRIEVANCES - POLICY'), (b'GRIEVANCES - COMPLAINTS', b'GRIEVANCES - COMPLAINTS'), (b'GRIEVANCES - GROUP', b'GRIEVANCES - GROUP'), (b'GRIEVANCES - INDIVIDUAL', b'GRIEVANCES - INDIVIDUAL'), (b'GRIEVANCES - CLASSIFICATION', b'GRIEVANCES - CLASSIFICATION')], max_length=50, validators=[add_case.validators.validate_case_type])),
                ('status', models.CharField(blank=True, choices=[(b"ACTION REQ'D SPFA", b"ACTION REQ'D SPFA"), (b'OPEN', b'OPEN'), (b'PENDING', b'PENDING'), (b'CLOSED', b'CLOSED'), (b"ACTION REQ'D - MGMT", b"ACTION REQ'D - MGMT")], max_length=50, validators=[add_case.validators.validate_status])),
                ...
                ('logs', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='contact_log.contactLog')),
            ],
        ),
        migrations.CreateModel(
            name='CaseFiles',
