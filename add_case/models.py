...
class Case(models.Model):
    ...
    caseType = models.CharField(max_length=50, default='GRIEVANCES - INDIVIDUAL', validators=[validate_case_type])
    status = models.CharField(default='OPEN', max_length=50, blank=True,validators=[validate_status])
